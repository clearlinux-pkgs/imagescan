...
%prep
%setup -q -n utsushi-0.62.0
cd %{_builddir}/utsushi-0.62.0
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588702490
...
cp %{_builddir}/utsushi-0.62.0/COPYING %{buildroot}/usr/share/package-licenses/imagescan/5d5b272eee7052483f8893c6da9de0c258b1036c
cp %{_builddir}/utsushi-0.62.0/upstream/boost/LICENSE_1_0.txt %{buildroot}/usr/share/package-licenses/imagescan/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
cp %{_builddir}/utsushi-0.62.0/upstream/boost/tools/bcp/licence_info.cpp %{buildroot}/usr/share/package-licenses/imagescan/bf3f8ac9bd569a03cfabf79b75d5fa70440407c8
cp %{_builddir}/utsushi-0.62.0/upstream/boost/tools/bcp/licence_info.hpp %{buildroot}/usr/share/package-licenses/imagescan/d7d282609a551cd74bba985bf9f93c2bbffea35b
cp %{_builddir}/utsushi-0.62.0/upstream/boost/tools/build/v2/engine/debian/copyright %{buildroot}/usr/share/package-licenses/imagescan/91367cdb429a2ecf03f07f332c27a3588aa8915e
cp %{_builddir}/utsushi-0.62.0/upstream/ltdl/COPYING.LIB %{buildroot}/usr/share/package-licenses/imagescan/3ac522f07da0f346b37b29cd73a60f79e992ffba
%make_install
%find_lang utsushi
