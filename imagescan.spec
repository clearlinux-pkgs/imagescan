...
Version  : 3.65.0
Release  : 11
URL      : http://support.epson.net/linux/src/scanner/imagescanv3/common/imagescan_3.65.0.orig.tar.gz
Source0  : http://support.epson.net/linux/src/scanner/imagescanv3/common/imagescan_3.65.0.orig.tar.gz
Summary  : Build tool
...
Patch3: 0003-Fix-build-with-autoconf-2.70.patch
Patch4: imagescan-gcc10.patch
Patch5: boost-1.74.patch
...
%prep
%setup -q -n utsushi-0.65.0
cd %{_builddir}/utsushi-0.65.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616611835
...
cp %{_builddir}/utsushi-0.65.0/COPYING %{buildroot}/usr/share/package-licenses/imagescan/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/utsushi-0.65.0/upstream/boost/LICENSE_1_0.txt %{buildroot}/usr/share/package-licenses/imagescan/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
cp %{_builddir}/utsushi-0.65.0/upstream/boost/tools/bcp/licence_info.cpp %{buildroot}/usr/share/package-licenses/imagescan/bf3f8ac9bd569a03cfabf79b75d5fa70440407c8
cp %{_builddir}/utsushi-0.65.0/upstream/boost/tools/bcp/licence_info.hpp %{buildroot}/usr/share/package-licenses/imagescan/d7d282609a551cd74bba985bf9f93c2bbffea35b
cp %{_builddir}/utsushi-0.65.0/upstream/boost/tools/build/v2/engine/debian/copyright %{buildroot}/usr/share/package-licenses/imagescan/91367cdb429a2ecf03f07f332c27a3588aa8915e
cp %{_builddir}/utsushi-0.65.0/upstream/ltdl/COPYING.LIB %{buildroot}/usr/share/package-licenses/imagescan/3ac522f07da0f346b37b29cd73a60f79e992ffba
%make_install
%find_lang utsushi
...
/usr/lib64/sane/libsane-utsushi.so.1.0.32
...
/usr/lib64/utsushi/sane/libsane-utsushi.so.1.0.32
...
/usr/share/package-licenses/imagescan/8624bcdae55baeef00cd11d5dfcfa60f68710a02
